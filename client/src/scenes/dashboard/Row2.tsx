...
const Row2 = (props: Props) => {
	...
	const handleDelete = async (id, type) => {
		try {
			...
			switch (type) {
				case 'Spending':
					endpoint = `${import.meta.env.REACT_APP_API_URL}/spending/spendings/${id}`;
					break;
				case 'Goal':
					console.log(id);
					endpoint = `${import.meta.env.REACT_APP_API_URL}/goal/goals/${id}`;
					break;
				default:
	...
	const handleCreate = async (formData) => {
		...
		try {
			...
			switch (formData.type) {
				case 'Income':
					endpoint = '${import.meta.env.REACT_APP_API_URL}/income/incomes';
					break;
				case 'Spending':
					endpoint = '${import.meta.env.REACT_APP_API_URL}/spending/spendings';
					break;
				case 'Goal':
					endpoint = '${import.meta.env.REACT_APP_API_URL}/goal/goals';
					break;
				case 'Budget':
					endpoint = '${import.meta.env.REACT_APP_API_URL}/budget/budgets';
					break;
				default:
					throw new Error('Invalid form type');
			}
